...
bool i2cWriteBuffer ( uint8_t addr_, uint8_t reg, uint8_t len, uint8_t *buf ) {
  addr_ <<= 1;
...
bool i2cWriteBufferwithoutregister ( uint8_t addr_, uint8_t len, uint8_t *buf ) {
  addr_ <<= 1;
...
bool i2cWritewithoutregister ( uint8_t addr_, uint8_t data ) {
  return i2cWriteBufferwithoutregister ( addr_, 1, &data );
}
...
// For VL53L1x
bool i2cWriteBuffer_v2 ( uint8_t addr_, uint16_t reg, uint8_t len, uint8_t *buf ) {
  addr_ <<= 1;
  uint8_t regL, regH;
...
bool i2cWrite_v2 ( uint8_t addr_, uint16_t reg_, uint8_t data ) {
  return i2cWriteBuffer_v2 ( addr_, reg_, 1, &data );
}
